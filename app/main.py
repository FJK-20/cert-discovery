...
app = FastAPI(
    ...
    lifespan=_lifespan,
    # Achado numa auditoria de robustez: /docs, /redoc e /openapi.json
    # ficam públicos por padrão, sem autenticação — mapa completo da API
    # de graça pra qualquer um. Desligado por padrão (CERTDISC_ENABLE_API_DOCS).
